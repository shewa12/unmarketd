...
<!--selectize css-->
    ...
    <link rel="stylesheet" href="{{url('public/selectize/normalize.css')}}">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <!-- menu profile quick info -->
              @include('freelancer.profileinfo')
            <!-- /menu profile quick info -->

            <br />

            <!-- sidebar menu -->
              @include('freelancer.sidebar')
            <!-- /sidebar menu -->
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                @else
                  <img class="thumbnail" src="{{url('/storage/app/avatars/')}}/{{Auth::user()->image}}" style="width:40px; height:40px; border-radius:50%;">
                @endif
                </li>
                <li>
...
-->
        ...
        <footer>
          <div class="pull-right">
            &copy; All Rights & Reserved <a href="{{url('')}}">Unmarketd</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
