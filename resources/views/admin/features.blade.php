...
@section('content')
	<div class="right_col" role="main">
        ...
        <div class="responsive">
            <button class="btn-default btn btn-sm" data-toggle="modal" data-target="#addform"><i class="fas fa-plus-circle"></i>Feature</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{route('saveFeature')}}" enctype="multipart/form-data">
              {{ csrf_field() }}
...
<div class="modal fade" id="editform" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{route('updateFeature')}}" enctype="multipart/form-data">
              {{ csrf_field() }}
