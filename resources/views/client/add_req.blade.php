	...
	<div class="row">
		<div class="panel-default panel col-md-10">
			...
			<div class="panel-body">
				...
				<form class="form-horizontal" action="{{route('createReq')}}" method="post" enctype="multipart/form-data">
					{{csrf_field()}}
                        ...
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="text" class="form-control" name="title" placeholder="title" value="{{ old('title') }}" autofocus required>
                        ...
                        <div class="form-group{{ $errors->has('contact_person') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="text" class="form-control" name="contact_person" placeholder="contact person" value="{{ old('contact_person') }}" autofocus required>
                        ...
                        <div class="form-group{{ $errors->has('workload_hour') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="number" class="form-control" name="workload_hour"  placeholder="hours/week" value="{{ old('workload_hour') }}" autofocus required>
                        ...
                        <div class="form-group{{ $errors->has('noof_freelancer') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="text" class="form-control" name="noof_freelancer"  placeholder="10" value="{{ old('noof_freelancer') }}" autofocus required>
                        ...
                        <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="name" type="" class="form-control" name="start_date" onfocus="(this.type='date')" placeholder="start date" value="{{old('start_date')}}" required>
                                ...
                                <input id="name" type="" class="form-control" name="end_date"  placeholder="end date" onfocus= "(this.type='date')" value="{{ old('end_date') }}" required>
